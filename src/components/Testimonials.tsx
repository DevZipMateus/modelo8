...
const Testimonials = () => {
  return <section id="clients" className="section py-20 bg-transparent">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {clients.map(client => <div key={client.id} className="bg-white shadow-sm hover:shadow-md transition-all p-8 rounded-lg flex items-center justify-center h-48">
