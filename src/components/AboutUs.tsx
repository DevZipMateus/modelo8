        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className="lg:w-1/2 animate-fade-in">
            <div className="relative">
              ...
              <img 
                src="https://images.unsplash.com/photo-1538592116845-119a26d80a2c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" 
                alt="Equipe de produção de uniformes" 
          ...
          <div className="lg:w-1/2">
            ...
            <a 
              href="#contact" 
              className="bg-ds3-dark hover:bg-ds3-dark/90 text-ds3-gold px-6 py-3 rounded-md transition-all flex items-center justify-center gap-2 font-medium inline-flex animate-fade-in" 
