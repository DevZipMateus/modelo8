...
const Hero = () => {
  ...
  return <section className="relative h-screen min-h-[600px] flex items-center pt-24">
      {/* Background Image with Overlay */}
      <div className="absolute inset-0 z-0">
        <img src="/lovable-uploads/66ded53a-d6e4-4b83-b0cf-f477bffcd5cd.png" alt="Trabalhador offshore com vista para plataforma petrolífera" className="w-full h-full object-cover" />
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl py-0">
          ...
          {/* Service Categories */}
          <div className="mt-24 md:mt-32 grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in" style={{
          animationDelay: '0.3s'
        }}>
